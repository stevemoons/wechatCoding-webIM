...
}.bind(window))(function (StropheInner, buildInner, msgInner, iqInner, presInner) {
    Strophe = StropheInner;
    $build = buildInner;
    $msg = msgInner;
    $iq = iqInner;
    $pres = presInner;
    window.Strophe = StropheInner;
    window.$build = buildInner;
    window.$msg = msgInner;
    window.$iq = iqInner;
    window.$pres = presInner;
});
/* jshint ignore:end */
